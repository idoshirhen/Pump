...
// V4 is intentionally excluded: its USDA fallback staples were superseded by
// the corrected/pinned V5-V7 records. Keeping both batches would create
// duplicate canonical IDs/aliases and make lookup order determine nutrition.
