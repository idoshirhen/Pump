...
function ConnectedApp({ inputProfile, mode = 'connected' }) {
...
function AuthenticatedApp({ session }) {
  ...
  if (profileState.status === 'error') {
    return <BootScreen title="לא הצלחנו לטעון את הפרופיל" detail={profileState.error?.message || 'נסה לרענן את האפליקציה.'} />;
  }
  ...
  return <ConnectedApp inputProfile={profileState.record.profile} />;
}
