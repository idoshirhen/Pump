...
const pumpMealCatalog = [
  ...
  pumpCatalogEntry('skyr-oats-fruit', ['breakfast'], 'לחמנייה עם גבינה, ביצה וסלט', ['vegetarian', 'dairy', 'eggs', 'bread', 'gluten', 'quick'], 'eggs', 390, 30, 53, 7, [pumpIngredient('לחמנייה מלאה', 1, 'יח׳'), pumpIngredient('גבינה 5%', 120), pumpIngredient('ביצה קשה', 1, 'יח׳'), pumpIngredient('סלט ירקות', 1, 'קערה', false)]),
  pumpCatalogEntry('protein-yogurt-bowl', ['breakfast'], 'גבינה לבנה, לחם וסלט', ['vegetarian', 'dairy', 'bread', 'gluten', 'quick'], 'dairy', 420, 32, 55, 9, [pumpIngredient('גבינה לבנה 5%', 200), pumpIngredient('לחם מלא', 3, 'פרוסות'), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('זיתים', 20)]),
  ...
  pumpCatalogEntry('overnight-oats', ['breakfast'], 'כריך חביתה וירקות', ['vegetarian', 'eggs', 'bread', 'gluten', 'quick', 'budget'], 'eggs', 400, 27, 56, 8, [pumpIngredient('לחם מלא', 3, 'פרוסות'), pumpIngredient('ביצים', 2, 'יח׳'), pumpIngredient('טחינה', 12), pumpIngredient('ירקות', 1, 'קערה', false)]),
  pumpCatalogEntry('egg-avocado-wrap', ['breakfast'], 'פיתה עם חביתה, טחינה וסלט', ['vegetarian', 'eggs', 'bread', 'gluten', 'tahini', 'quick'], 'eggs', 460, 28, 42, 21, [pumpIngredient('פיתה מלאה', 1, 'יח׳'), pumpIngredient('ביצים', 2, 'יח׳'), pumpIngredient('טחינה', 18), pumpIngredient('סלט ירקות', 1, 'קערה', false)]),
  pumpCatalogEntry('tuna-rice-cakes', ['breakfast'], 'כריך טונה וביצה', ['fish', 'tuna', 'eggs', 'bread', 'gluten', 'quick', 'budget'], 'tuna', 360, 30, 39, 8, [pumpIngredient('טונה במים מסוננת', 100), pumpIngredient('ביצה קשה', 1, 'יח׳'), pumpIngredient('לחם מלא', 2, 'פרוסות'), pumpIngredient('ירקות', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('pea-protein-oats', ['breakfast'], 'חומוס, בטטה וירקות', ['vegan', 'plant', 'legumes', 'potato', 'quick', 'budget'], 'legumes', 410, 29, 57, 8, [pumpIngredient('חומוס', 150), pumpIngredient('בטטה אפויה', 220), pumpIngredient('טחינה', 15), pumpIngredient('סלט ירקות', 1, 'קערה', false)]),
  pumpCatalogEntry('chickpea-pancake', ['breakfast'], 'פול, תפוח אדמה וטחינה', ['vegan', 'plant', 'legumes', 'potato', 'tahini', 'quick', 'budget'], 'legumes', 400, 23, 48, 14, [pumpIngredient('פול מבושל', 240), pumpIngredient('תפוח אדמה אפוי', 180), pumpIngredient('טחינה', 18), pumpIngredient('סלט ירקות', 1, 'קערה', false)]),
  pumpCatalogEntry('hummus-sweet-potato', ['breakfast'], 'חומוס, פיתה וסלט', ['vegan', 'plant', 'legumes', 'bread', 'gluten', 'quick', 'budget'], 'legumes', 420, 20, 63, 11, [pumpIngredient('חומוס', 170), pumpIngredient('פיתה מלאה', 1, 'יח׳'), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('זיתים', 20)]),
  pumpCatalogEntry('quinoa-fruit-protein', ['breakfast'], 'מג׳דרה, טחינה וסלט', ['vegan', 'plant', 'legumes', 'rice', 'tahini', 'quick'], 'legumes', 410, 27, 60, 7, [pumpIngredient('מג׳דרה מבושלת', 270), pumpIngredient('טחינה', 20), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('לימון', 1, 'מנה', false)]),
  pumpCatalogEntry('rice-cakes-hummus', ['breakfast'], 'סלט חומוס, תפוח אדמה וטחינה', ['vegan', 'plant', 'legumes', 'potato', 'tahini', 'quick', 'budget'], 'legumes', 340, 17, 49, 8, [pumpIngredient('חומוס', 120), pumpIngredient('תפוח אדמה אפוי', 180), pumpIngredient('טחינה', 12), pumpIngredient('עגבנייה ומלפפון', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('protein-smoothie', ['breakfast'], 'ביצה קשה, גבינה, לחם וירקות', ['vegetarian', 'dairy', 'eggs', 'bread', 'gluten', 'quick', 'budget'], 'eggs', 390, 31, 51, 6, [pumpIngredient('ביצים קשות', 2, 'יח׳'), pumpIngredient('גבינה 5%', 100), pumpIngredient('לחם מלא', 2, 'פרוסות'), pumpIngredient('ירקות', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('chicken-potato-tray', ['lunch'], 'פרגיות בתנור, תפוחי אדמה וסלט', ['meat', 'chicken', 'potato', 'quick', 'budget'], 'chicken', 580, 48, 57, 16, [pumpIngredient('פרגיות בתנור', 180), pumpIngredient('תפוחי אדמה אפויים', 280), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('טחינה', 15)]),
  ...
  pumpCatalogEntry('chicken-pasta', ['lunch'], 'פתיתים עם עוף וסלט', ['meat', 'chicken', 'couscous', 'gluten', 'quick', 'budget'], 'chicken', 630, 51, 72, 13, [pumpIngredient('פרגיות או חזה עוף', 170), pumpIngredient('פתיתים מבושלים', 230), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('טחינה', 15)]),
  ...
  pumpCatalogEntry('tofu-curry-quinoa', ['lunch'], 'קציצות עדשים ברוטב עם אורז', ['vegan', 'plant', 'legumes', 'rice', 'quick', 'budget'], 'legumes', 590, 34, 67, 20, [pumpIngredient('קציצות עדשים', 220), pumpIngredient('אורז מבושל', 200), pumpIngredient('רוטב עגבניות', 160), pumpIngredient('סלט ירקות', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('chickpea-curry-rice', ['lunch'], 'תבשיל חומוס ברוטב עגבניות ואורז', ['vegan', 'plant', 'legumes', 'rice', 'quick', 'budget'], 'legumes', 570, 22, 88, 13, [pumpIngredient('חומוס מבושל', 190), pumpIngredient('אורז מבושל', 190), pumpIngredient('רוטב עגבניות', 180), pumpIngredient('סלט ירקות', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('tempeh-rice-bowl', ['lunch'], 'קציצות עדשים, אורז וסלט', ['vegan', 'plant', 'legumes', 'rice', 'quick', 'budget'], 'legumes', 590, 35, 65, 19, [pumpIngredient('קציצות עדשים', 220), pumpIngredient('אורז מבושל', 190), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('טחינה', 18)]),
  pumpCatalogEntry('salmon-sushi-bowl', ['lunch'], 'דג בתנור, פתיתים וסלט', ['fish', 'salmon', 'couscous', 'gluten'], 'fish', 600, 39, 68, 20, [pumpIngredient('דג בתנור', 170), pumpIngredient('פתיתים מבושלים', 210), pumpIngredient('סלט ירקות', 1, 'קערה', false), pumpIngredient('טחינה', 15)]),
  ...
  // Snacks — 20 meals
  pumpCatalogEntry('skyr-fruit-snack', ['snack'], 'יוגורט ופרי', ['vegetarian', 'dairy', 'yogurt', 'fruit', 'quick'], 'dairy', 190, 19, 24, 2, [pumpIngredient('יוגורט טבעי', 200), pumpIngredient('פרי טרי', 1, 'יח׳')]),
  ...
  pumpCatalogEntry('protein-shake-banana', ['snack'], 'כריך ביצה קטן', ['vegetarian', 'eggs', 'bread', 'gluten', 'quick', 'budget'], 'eggs', 240, 25, 31, 3, [pumpIngredient('ביצה קשה', 1, 'יח׳'), pumpIngredient('לחם מלא', 2, 'פרוסות'), pumpIngredient('טחינה', 10), pumpIngredient('ירקות', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('soy-yogurt-fruit', ['snack'], 'תמרים ואגוזים', ['vegan', 'plant', 'nuts', 'fruit', 'quick', 'budget'], 'nuts', 220, 15, 31, 7, [pumpIngredient('תמרים', 3, 'יח׳'), pumpIngredient('אגוזים', 25), pumpIngredient('פרי טרי', 1, 'יח׳')]),
  pumpCatalogEntry('pea-protein-shake', ['snack'], 'כריך חומוס קטן', ['vegan', 'plant', 'legumes', 'bread', 'gluten', 'quick', 'budget'], 'legumes', 210, 23, 26, 3, [pumpIngredient('לחם מלא', 2, 'פרוסות'), pumpIngredient('חומוס', 100), pumpIngredient('ירקות', 1, 'קערה', false)]),
  ...
  pumpCatalogEntry('oat-protein-bites', ['snack'], 'תמרים, אגוזים וטחינה', ['vegan', 'plant', 'nuts', 'tahini', 'fruit', 'quick', 'budget'], 'nuts', 230, 17, 26, 9, [pumpIngredient('תמרים', 3, 'יח׳'), pumpIngredient('אגוזים', 20), pumpIngredient('טחינה', 12)]),
...
const pumpCatalogProteinBoosters = [
  ...
  { id: 'extra-protein-yogurt', title: 'יוגורט חלבון', tags: ['vegetarian', 'dairy', 'yogurt', 'quick'], caloriesPerGram: 0.62, proteinPerGram: 0.11 },
  ...
  { id: 'extra-lupin', title: 'תורמוס מבושל', tags: ['vegan', 'plant', 'legumes', 'quick', 'budget'], caloriesPerGram: 1.20, proteinPerGram: 0.16 },
];
...
function pumpCatalogScale(recipe, targetCalories, targetProtein, profile, slot) {
  ...
  const proteinCandidate = fit?.candidate;
  const proteinFit = fit?.fit;
